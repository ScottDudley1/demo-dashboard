...
const GoogleAnalyticsFilters = ({
  ...
  return (
    <Box sx={{ display: 'flex', gap: 2 }}>
      {renderSelect(countries, selectedCountry, onCountryChange, 'Country')}
      {renderSelect(cities, selectedCity, onCityChange, 'City')}
      {renderSelect(sources, selectedSource, onSourceChange, 'Source')}
      {renderSelect(mediums, selectedMedium, onMediumChange, 'Medium')}
      {renderSelect(browsers, selectedBrowser, onBrowserChange, 'Browser')}
      {renderSelect(devices, selectedDevice, onDeviceChange, 'Device')}
    </Box>
  );
};

export default GoogleAnalyticsFilters; 